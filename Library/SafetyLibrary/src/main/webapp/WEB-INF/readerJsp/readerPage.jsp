    ...
    <table class="table table-striped table-hover ">
        ...
        <c:forEach items="${readerList }" var="reader">
            <tr>
                ...
                <td>
                    <a href="<%=basePath%>/reader/editReader/${reader.rdID}?start=${start}"><span
                            class="glyphicon glyphicon-edit"></span></a>
                    <a href="<%=basePath%>/reader/deleteReader?rdID=${reader.rdID}&start=${start}"><span
...
<a href="<%=basePath%>/reader/exportExcel?start=${start}&rdID=${rdID}"><span
        class="glyphicon glyphicon-save">导出Excel表</span></a>
<div class="row">
    <hr/>
</div>
<div class="row">
    <form class=" form-inline  col-md-10" action="reader/updateReader/${start }" method="post"
          enctype="multipart/form-data">
        <div class="form-group">
            <span>用户名&nbsp;&nbsp;:</span>
            <input type="text" class="form-control" name="rdID" placeholder="用户名" value="${editReader.rdID }"
                   readonly="readonly"/>
        </div>
        <div class="form-group">
            <span>姓名&nbsp;&nbsp;&nbsp;&nbsp;:</span>
