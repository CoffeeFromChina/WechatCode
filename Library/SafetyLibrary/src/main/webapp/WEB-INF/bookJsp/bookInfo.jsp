...
<div class="row col-sm-1">
    ...
    <br/>
    <a href="<%=basePath%>/book/exportBook?start=${parameter.start}&bkStatus=${parameter.bkStatus}&bkName=${parameter.bkName}"><span
            class="glyphicon glyphicon-save"><span>导出Excel表</span></span></a>
</div>
    ...
    <table class="table table-striped table-hover ">
        ...
        <c:forEach items="${BookList }" var="book">
            <tr>
                ...
                <td>${book.bkStatus }</td>
                <td>
                    <a href="<%=basePath%>/book/editBook?bkID=${book.bkID}&start=-1&end=-1"><span
                            class="glyphicon glyphicon-edit"></span></a>
                    <a href="javascript:void(0)"
                       onclick="if(confirm('你确定删除?')){location.href='<%=basePath %>/book/deleteBook?start=${parameter.start }&bkID=${book.bkID }'; window.reload();}"><span
